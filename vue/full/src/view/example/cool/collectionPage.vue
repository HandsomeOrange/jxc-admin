<template>
  <list-page :data="listPageConfig">
    <template v-slot:searchForm>
      <el-form-item label="Shopify产品类别链接" label-width="160px">
        <el-input placeholder="example:http://www.xxxx.com/collections/bag" v-model="searchForm.collectionUrl" clearable
                  maxlength="50"/>
      </el-form-item>
    </template>
    <template v-slot:tableColumn>
      ...
      <el-table-column align="center" label="耗 时" prop="duration" width="100"/>
